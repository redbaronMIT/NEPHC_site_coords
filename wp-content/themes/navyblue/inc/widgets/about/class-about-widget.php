<?php
/**
 * About NavyBlue  widget.
 *
 * @package NavyBlue
 */

if ( ! class_exists( 'NavyBlue_About_Widget' ) ) {

	class NavyBlue_About_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display an information about your site.', 'navyblue' );
			$this->widget_id          = 'navyblue_widget_about';
			$this->widget_name        = esc_html__( 'About NavyBlue ', 'navyblue' );
			$this->settings           = array(
				'title'  => array(
					'type'  => 'text',
					'value' => '',
				...
				'media_id' => array(
					...
					'value'              => '',
					'label'              => esc_html__( 'Logo:', 'navyblue' ),
				),
				'enable_tagline' => array(
					...
					'options' => array(
						'enable_tagline' => esc_html__( 'Enable Tagline:', 'navyblue' ),
					),
				),
				'content'  => array(
					'type'              => 'textarea',
					'placeholder'       => esc_html__( 'Text or HTML', 'navyblue' ),
					'value'             => '',
		...
		public function widget( $args, $instance ) {
			...
			if ( $tagline_enabled ) {
				$format   = apply_filters( 'navyblue_about_widget_tagline_format', '<p>%s</p>', $this->settings, $this->args );
...
add_action( 'widgets_init', 'navyblue_register_about_widget' );
function navyblue_register_about_widget() {
	register_widget( 'NavyBlue_About_Widget' );
}
