...
if ( ! class_exists( 'NavyBlue_Widget_Area' ) ) {

	class NavyBlue_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'navyblue_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'navyblue_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'navyblue_widget_area_classes', $classes, $area_id );
	...
	function navyblue_widget_area() {
		return NavyBlue_Widget_Area::get_instance();
	}

	navyblue_widget_area();
}
