 ...
 */
add_filter( 'template_include', array( 'NavyBlue_Wrapping', 'wrap' ), 99 );
add_filter( 'navyblue_wrap_base', 'navyblue_wrap_base_cpts' );
 ...
 */
function navyblue_template_path() {
	return NavyBlue_Wrapping::$main_template;
}
 ...
 */
function navyblue_template_base() {
	return NavyBlue_Wrapping::$base;
}

if ( ! class_exists( 'NavyBlue_Wrapping' ) ) {
	...
	class NavyBlue_Wrapping {
		...
		/**
		 * Initialize new instance of NavyBlue_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'navyblue_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in NavyBlue_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function navyblue_wrap_base_cpts( $templates ) {
