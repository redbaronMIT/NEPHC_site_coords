...
Class PMS_Shortcodes {
    ...
    public static function register_form( $atts ) {
        ...
        if( is_user_logged_in() ) {
            ...
            if( !$users_can_register ) {
                ...
                $redirect_url = apply_filters( 'pms_register_form_logout_redirect_url', pms_get_current_page_url() );
                ...
                echo apply_filters( 'pms_register_form_already_a_user_message', '<p>' . sprintf( __( 'You are currently logged in as %s.', 'paid-member-subscriptions'), $user->display_name ) . ' ' . $logout_url . '</p>', $atts );
    ...
    public static function member_account( $atts ) {
        ...
        return apply_filters( 'pms_account_shortcode_content', $output );
