...
<div id="payments-general">
    ...
    <div class="pms-form-field-wrapper">
        <label class="pms-form-field-label" for="payment-test-mode"><?php _e( 'Test Mode', 'paid-member-subscriptions' ) ?></label>

        <p class="description"><input type="checkbox" id="payment-test-mode" name="pms_payments_settings[test_mode]" value="1" <?php echo ( isset( $this->options['test_mode'] ) ? 'checked' : '' ); ?> /><?php _e( 'By checking this option you will be able to use Paid Member Subscriptions with test accounts from your payment processors.', 'paid-member-subscriptions' ); ?></p>
    </div>
