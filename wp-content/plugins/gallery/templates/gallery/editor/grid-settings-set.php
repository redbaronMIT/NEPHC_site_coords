 ...
 */
?>
<h6><?php esc_attr_e( 'Choose display type for your set', 'tm_gallery' ); ?></h6>
	...
	<div class="tm-pg_gallery_grid-settings-type_properties tm-pg_column">
		<div class="tm-pg_gallery_grid-settings-type_properties_holder">
			...
			<div data-type="height">
				<p>
					<label>
						<span><?php esc_attr_e( 'Fixed height', 'tm_gallery' ); ?> </span>
					</label>
					<input type="number" name="height" min="50" max="350" maxlength="3">
				</p>
			</div>
			<div data-type="gutter">
				<p>
					...
					<input type="number" name="gutter" min="0" max="50" maxlength="2" id="gutter">
				</p>
			</div>
